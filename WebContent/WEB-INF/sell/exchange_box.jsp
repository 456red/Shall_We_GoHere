...
<script type="text/javascript">
	$(function(){
		...
		$("#amount").keyup(function(){
			price = $(this).val()*15000;
			$("#tot").text("Point Total : "+price+"P");
			$(".buy").html("<a href='buy.sell?price="+price+"'>BUY NOW</a>");
		});
		...
		<article class="product_board_2">
			<div class="product_list">
				...
				<div class="info_board">
					...
					<div id="quantity">
						수량 : <input type="number" placeholder="필수 선택" id="amount">
					</div>
					<div class="info" id="tot">Point Total : 0P</div>
					<div class="buy">
						<a href="#">BUY NOW</a>
					</div>
					<div class="cart">
